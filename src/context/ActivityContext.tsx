...
import { ActivityActions, activityReducer, ActivityState, initalState } from '../reducer/activity-reducer';
...
export const ActivityProvider = ({ children } : ActivityProviderProps ) => {
    ...
    return (
        <ActivityContext.Provider value={{
            state, dispatch,
            caloriesConsumed, caloriesBurned, netCalories,
            categoryName, isEmptyActivities
        }} >
        { children }
